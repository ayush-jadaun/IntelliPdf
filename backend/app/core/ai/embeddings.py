...
class SentenceTransformerEmbedder(EmbeddingProvider):
    ...
    def get_model_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "max_input_tokens": 512,  # Most models have this limit
            "status": "available",
            "local": True
        }
...
class OpenAIEmbedder(EmbeddingProvider):
    ...
    def __init__(self, model: str = "text-embedding-3-small", api_key: Optional[str] = None):
        ...
        Models:
        - text-embedding-3-small: Fast, 1536 dimensions, $0.02/1M tokens
        - text-embedding-3-large: Best quality, 3072 dimensions, $0.13/1M tokens
...
class HuggingFaceEmbedder(EmbeddingProvider):
    ...
    def __init__(self, model: str = "sentence-transformers/all-MiniLM-L6-v2", api_key: Optional[str] = None):
        ...
        - intfloat/e5-large-v2: High quality, 1024 dim
        """
        try:
            import requests
    ...
    def embed_texts(self, texts: List[str]) -> List[List[float]]:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return [[0.0] * 384 for _ in texts]  # Default dimension fallback
...
class UniversalEmbedder:
    ...
    def embed_texts(
        ...
        Args:
            texts: List of strings or dictionaries with 'text' key
...
def create_embedder(provider: str, **kwargs) -> UniversalEmbedder:
    ...
    Args:
        provider: One of 'sentence_transformers', 'openai', 'huggingface', 'cohere'
        **kwargs: Provider-specific arguments
        
    Returns:
        UniversalEmbedder instance
    """
    providers = {

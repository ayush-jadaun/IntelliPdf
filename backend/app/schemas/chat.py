...
class FileAttachment(BaseModel):
    ...
    metadata: Optional[Dict[str, Any]] = Field(None, description="Extracted metadata such as page count, title, etc.")
...
class ChatMessage(BaseModel):
    ...
    attachments: Optional[List[FileAttachment]] = Field(None, description="List of attached files")
    metadata: Optional[Dict[str, Any]] = Field(None, description="Optional metadata (e.g., message id, source, etc.)")
